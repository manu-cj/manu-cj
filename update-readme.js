...
const libraries = [
  { name: "Entity Framework Core", language: "C#", link: "https://learn.microsoft.com/en-us/ef/core/", description: "ORM permettant de travailler avec des bases de données en utilisant des objets .NET." },
  { name: "Dapper", language: "C#", link: "https://github.com/DapperLib/Dapper", description: "Micro-ORM rapide et léger pour exécuter des requêtes SQL efficacement." },
  { name: "AutoMapper", language: "C#", link: "https://automapper.org/", description: "Outil de mapping automatique entre objets .NET." },
  { name: "MediatR", language: "C#", link: "https://github.com/jbogard/MediatR", description: "Implémentation du pattern Mediator pour simplifier la communication entre objets." },
  { name: "Serilog", language: "C#", link: "https://serilog.net/", description: "Framework de logging structuré pour .NET." },
  { name: "NLog", language: "C#", link: "https://nlog-project.org/", description: "Bibliothèque avancée de logging pour .NET." },
  { name: "Newtonsoft.Json", language: "C#", link: "https://www.newtonsoft.com/json", description: "Bibliothèque de sérialisation JSON populaire pour .NET." },
  { name: "FluentValidation", language: "C#", link: "https://fluentvalidation.net/", description: "Framework pour la validation fluide des modèles .NET." },
  { name: "MassTransit", language: "C#", link: "https://masstransit.io/", description: "Bibliothèque de messagerie distribuée pour .NET." },
  { name: "Hangfire", language: "C#", link: "https://www.hangfire.io/", description: "Gestionnaire de tâches en arrière-plan pour .NET." },
  { name: "xUnit", language: "C#", link: "https://xunit.net/", description: "Framework de test unitaire pour .NET." },
  { name: "BenchmarkDotNet", language: "C#", link: "https://benchmarkdotnet.org/", description: "Bibliothèque pour mesurer les performances de code C#." },
  { name: "Polly", language: "C#", link: "https://github.com/App-vNext/Polly", description: "Bibliothèque de résilience pour gérer les échecs intermittents." },
  { name: "Quartz.NET", language: "C#", link: "https://www.quartz-scheduler.net/", description: "Planificateur de tâches avancé pour .NET." },
  { name: "Rebus", language: "C#", link: "https://github.com/rebus-org/Rebus", description: "Framework de messagerie simple pour .NET." },
  { name: "IdentityServer", language: "C#", link: "https://identityserver.io/", description: "Framework d'authentification et d'autorisation pour .NET." },
  { name: "MiniProfiler", language: "C#", link: "https://miniprofiler.com/", description: "Outil de profilage léger pour les applications .NET." },
  { name: "SharpZipLib", language: "C#", link: "https://icsharpcode.github.io/SharpZipLib/", description: "Bibliothèque pour manipuler les fichiers compressés." },
  { name: "RestSharp", language: "C#", link: "https://restsharp.dev/", description: "Client HTTP pour interagir avec des API REST." },
  { name: "CsvHelper", language: "C#", link: "https://joshclose.github.io/CsvHelper/", description: "Bibliothèque pour lire et écrire des fichiers CSV." },
  { name: "Moq", language: "C#", link: "https://github.com/moq/moq", description: "Framework de mocking pour les tests unitaires .NET." },
  { name: "SignalR", language: "C#", link: "https://dotnet.microsoft.com/en-us/apps/aspnet/signalr", description: "Framework pour les applications temps réel en .NET." },
  { name: "Blazor", language: "C#", link: "https://dotnet.microsoft.com/en-us/apps/aspnet/web-apps/blazor", description: "Framework permettant de créer des applications web interactives en C#." },
  { name: "Akka.NET", language: "C#", link: "https://getakka.net/", description: "Framework pour la programmation concurrente et distribuée." },
  { name: "Selenium WebDriver", language: "C#", link: "https://www.selenium.dev/", description: "Outil d'automatisation de tests pour les applications web." },
  { name: "OpenTelemetry", language: "C#", link: "https://opentelemetry.io/", description: "Framework d'observabilité pour la télémétrie des applications." },
  { name: "Ocelot", language: "C#", link: "https://github.com/ThreeMammals/Ocelot", description: "Bibliothèque de gestion de passerelle API pour .NET." },
  { name: "SharpDX", language: "C#", link: "https://github.com/sharpdx/SharpDX", description: "Wrapper DirectX pour le développement graphique en .NET." },
  { name: "LiteDB", language: "C#", link: "https://www.litedb.org/", description: "Base de données NoSQL légère pour .NET." },
  { name: "Spring Boot", language: "Java", link: "https://spring.io/projects/spring-boot", description: "Framework facilitant le développement d'applications Java." },
  { name: "Hibernate", language: "Java", link: "https://hibernate.org/", description: "Framework ORM pour Java permettant d'interagir avec les bases de données." },
  { name: "Apache Commons", language: "Java", link: "https://commons.apache.org/", description: "Collection de bibliothèques Java utilitaires." },
  { name: "Gson", language: "Java", link: "https://github.com/google/gson", description: "Bibliothèque de sérialisation/désérialisation JSON." },
  { name: "Log4j", language: "Java", link: "https://logging.apache.org/log4j/2.x/", description: "Framework de logging pour Java." },
  { name: "JUnit", language: "Java", link: "https://junit.org/", description: "Framework de tests unitaires pour Java." },
  { name: "Lombok", language: "Java", link: "https://projectlombok.org/", description: "Outil permettant de réduire le code boilerplate en Java." },
  { name: "Vert.x", language: "Java", link: "https://vertx.io/", description: "Framework réactif pour développer des applications concurrentes." },
  { name: "RxJava", language: "Java", link: "https://github.com/ReactiveX/RxJava", description: "Programmation réactive en Java." },
